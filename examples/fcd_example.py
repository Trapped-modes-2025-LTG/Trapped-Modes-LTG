...
displaced = analyze.load_image(displaced_path)
...
fcd.fft_peaks(reference)        # show peaks
fcd.compute_calibration_factor(0.0022, reference, plot=True)            # show calibration factor
values = fcd.compute_height_map(reference, displaced, square_size,layers)       #tuple = (height_map, phases, calibration_factor)
