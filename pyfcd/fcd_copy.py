...
def compute_height_map(reference, displaced, square_size,layers = None, height=None, unwrap=True):
    ...
    if height is not None:
        if layers is None:
            height = height  # TODO: le estoy mandando ya la altura efectiva.
        else:
    ...
    height_gradient = -displacement_field / height    #TODO: height ya es el coeficiente de proporción.
